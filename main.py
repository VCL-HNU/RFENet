...
os.environ["WANDB_API_KEY"] = ' ' # for using wandb
...
hyper_ps = {
    ...
    # Template
    'N_TEMPLATE_VERTICES': 42016, # for training
    # 'N_TEMPLATE_VERTICES': 168058, # for testing
#
}
...
def main(hps):
    ...
    #add
    #hps['N_REF_POINTS_PER_STRUCTURE'] = 42016
    ###
    ...
    print('data:',hps['DATASET'],SupportedDatasets.DATASET_NAME.name)
...
#command: python main.py --dataset DATASET_NAME --train 