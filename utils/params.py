...
from Boundary_loss import SurfaceLoss_dice_entropy
...
hyper_ps_default={
    ...
    'VOXEL_LOSS_FUNC': [SurfaceLoss_dice_entropy()],
    # 'VOXEL_LOSS_FUNC': [torch.nn.CrossEntropyLoss(), SurfaceLoss_dice_entropy()],

    # The weights for the voxel loss functions
    'VOXEL_LOSS_FUNC_WEIGHTS': [0.01], # BCE
    ...
    # 'test':read_dataset_ids('/DATA/dataset_ids.txt', 'Test')},
    ...
    'RAW_DATA_DIR': "/dataroot/", # <<<< Needs to set (e.g. in main.py)

    # Directory of preprocessed data, e.g., containing thickness values from
    # FreeSurfer
    'PREPROCESSED_DATA_DIR': "/preprocessedroot/", # <<<< Needs to set (e.g. in main.py)
}
