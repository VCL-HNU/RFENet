...
### 2. Dataset
[OASIS-1](https://sites.wustl.edu/oasisbrains/home/oasis-1/) form [OASIS dataset](https://sites.wustl.edu/oasisbrains/). (The splits IDs for OASIS-1 dataset can be found in data/dataset_ids_oasis.txt)
